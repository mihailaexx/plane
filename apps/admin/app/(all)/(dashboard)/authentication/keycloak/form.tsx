...
export function InstanceKeycloakConfigForm(props: Props) {
  ...
  const KEYCLOAK_FORM_FIELDS: TControllerInputFormField[] = [
    {
      ...
      description: <>The base URL of your Keycloak server, e.g. &quot;https://keycloak.example.com/auth&quot;.</>,
      placeholder: "https://keycloak.example.com/auth",
      error: Boolean(errors.KEYCLOAK_SERVER_URL),
      required: true,
    },
    {
      key: "KEYCLOAK_REALM",
      type: "text",
      label: "Realm",
      description: <>The Keycloak realm name that contains your Plane client configuration.</>,
      placeholder: "master",
    ...
    },
    {
      ...
      type: "text",
      label: "Client ID",
      description: <>The client ID configured in your Keycloak realm for Plane.</>,
      placeholder: "plane",
    ...
    },
    {
      ...
      type: "password",
      label: "Client secret",
      description: <>Found in the Credentials tab of your Keycloak client configuration.</>,
  ...
  const KEYCLOAK_SERVICE_FIELD: TCopyField[] = [
    {
      ...
      description: (
        <>
          We will auto-generate this. Paste this into your Keycloak client{" "}
          <CodeBlock darkerShade>Valid Redirect URIs</CodeBlock> field.
        </>
      ),
    },
  ];
  ...
  const onSubmit = async (formData: KeycloakConfigFormValues) => {
    ...
    try {
      ...
      reset({
        KEYCLOAK_SERVER_URL: response.find((item) => item.key === "KEYCLOAK_SERVER_URL")?.value,
